...
from lib.create_DB_ORM import Poi, PoiType, PoiTheme, TargetAudience
...
from settings import NEO4J_URI, NEO4J_USER, NEO4J_PWD, \
    MARIADB_DB, MARIADB_HOST, MARIADB_PORT, MARIADB_USER, MARIADB_PWD, \
    MONGODB_URI, MONGODB_DB, MONGODB_POI_COLLECTION, DATAFILES_POI


def load_DATATOURISME_POI(
        file_dir: str,
    ...
    l_neo4j, l_mongodb = [], []
    l_mariadb_poi, l_mariadb_poi_type, l_mariadb_poi_theme, \
        l_mariadb_audience = [], [], [], []
        ...
        try:
            ...
            if res is None:
                ...
                poi_dic, poi_type_dic, poi_theme_dic, audience_dic, \
                    l_mariadb_poi, l_mariadb_poi_type, l_mariadb_poi_theme, \
                    l_mariadb_audience = create_POI_for_mariadb(
                        POI, UUID_gen, datatourisme_id, poi_dic, poi_type_dic,
                        poi_theme_dic, audience_dic, l_mariadb_poi,
                        l_mariadb_poi_type, l_mariadb_poi_theme,
                        l_mariadb_audience)
            ...
            # POI to update (one or more update values)
                    ...
                    res.LAST_UPDATE is not find_element(POI, 'lastUpdate'):
    ...
    load_POI_into_mariadb(session, l_mariadb_poi, l_mariadb_poi_type,
